...
public class YdmBlocks
{
    ...
    public static void registerItems(RegistryEvent.Register<Block> event)
    {
        ...
        registry.register(new DuelBlock(Block.Properties.of(Material.WOOD, MaterialColor.COLOR_YELLOW).harvestTool(ToolType.AXE).strength(5.0F, 6.0F).sound(SoundType.WOOD), Block.box(2D, 0, 2D, 14D, 1D, 14D)).setRegistryName(YDM.MOD_ID, "bamboo_duel_playmat"));
