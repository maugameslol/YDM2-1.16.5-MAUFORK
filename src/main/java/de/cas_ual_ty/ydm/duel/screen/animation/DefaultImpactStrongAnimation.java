...
public class DefaultImpactStrongAnimation extends SpinningSymbolAnimation
{
    
    public DefaultImpactStrongAnimation(float centerPosX, float centerPosY, int size, int endSize)
    {
