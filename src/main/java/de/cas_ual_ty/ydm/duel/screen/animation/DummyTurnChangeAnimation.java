...
public class DummyTurnChangeAnimation  extends Animation
{
	// TODO: Remove once TurnChangeAnimation looks the way I want it to
	boolean turnPlayer;
	
	public DummyTurnChangeAnimation(boolean turnPlayer)
    {
