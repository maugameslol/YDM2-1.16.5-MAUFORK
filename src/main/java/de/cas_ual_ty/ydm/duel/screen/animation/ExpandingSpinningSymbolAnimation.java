...
public class ExpandingSpinningSymbolAnimation extends Animation
{
    ...
    public ExpandingSpinningSymbolAnimation(float centerPosX, float centerPosY, int size, int endSize)
    {
