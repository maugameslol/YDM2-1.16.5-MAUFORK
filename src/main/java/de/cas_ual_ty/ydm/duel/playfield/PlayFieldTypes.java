...
public class PlayFieldTypes
{
    public static final PlayFieldType DEFAULT = new PlayFieldType(8000)
            ...
            .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.SET).addInteraction()
            .newInteraction().icon(ActionIcons.ACTIVATE_SPELL_TRAP).interactorIncluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
            .newInteraction().icon(ActionIcons.CONTINUE_EFFECT).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee)  -> new EffectContinueAction(ActionTypes.CONTINUE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.SET).addInteraction()
            .newInteraction().icon(ActionIcons.CONTINUE_EFFECT).interactorIncluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee)  -> new EffectContinueAction(ActionTypes.CONTINUE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
            .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.HAND).interactorCardNotNull().interacteeEquals(ZoneTypes.HAND).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().addInteraction()
            .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.GRAVEYARD).interactorCardNotNull().interacteeEquals(ZoneTypes.GRAVEYARD).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().addInteraction()
            .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.BANISHED).interactorCardNotNull().interacteeEquals(ZoneTypes.BANISHED).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
            .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorIncluded(PlayFieldTypes.getAllDeckZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllDeckZones()).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
            .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.EXTRA).interactorCardNotNull().interacteeEquals(ZoneTypes.EXTRA).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
