...
public class PlayFieldTypes
{
    public static final PlayFieldType DEFAULT = new PlayFieldType(8000)
            ...
            .newInteraction().icon(ActionIcons.NORMAL_SUMMON).interactorEquals(ZoneTypes.HAND).interactorCardNotNull().interacteeEquals(ZoneTypes.MONSTER).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.NORMAL_SUMMON, interactor, card, interactee, CardPosition.ATK, player)).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interacteeEmpty().addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.NORMAL_SUMMON_DEF).interactorEquals(ZoneTypes.HAND).interactorCardNotNull().interacteeEquals(ZoneTypes.MONSTER).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.NORMAL_SUMMON, interactor, card, interactee, CardPosition.DEF, player)).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interacteeEmpty().addInteraction()
            .newInteraction().icon(ActionIcons.SET).interactorEquals(ZoneTypes.HAND).interactorCardNotNull().interacteeEquals(ZoneTypes.MONSTER).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.SET, interactor, card, interactee, CardPosition.SET, player)).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interacteeEmpty().addInteraction()
            ...
            .newInteraction().icon(ActionIcons.TO_SPELL_TRAP_ATK).interactorExcluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.ATK, player)).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interacteeEmpty().addInteraction()
            .newInteraction().icon(ActionIcons.TO_SPELL_TRAP_ATK).interactorIncluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.ATK, player)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.ATK).addInteraction()
            ...
            .newInteraction().icon(ActionIcons.ATTACK).interactorIncluded(PlayFieldTypes.getAllFieldZones()).interactorCardAny().interacteeIncluded(PlayFieldTypes.getAllFieldZones()).interaction((player, interactor, card, interactee) -> new AttackAction(ActionTypes.ATTACK, interactor, interactee)).playerAndInteractorSameOwner().interactorAndInteracteeNotSameOwner().interactorNonEmpty().interacteeNonEmpty().addInteraction()
            .newInteraction().icon(ActionIcons.ATTACK_DIRECTLY).interactorIncluded(PlayFieldTypes.getAllFieldZones()).interactorCardAny().interacteeEquals(ZoneTypes.HAND).interaction((player, interactor, card, interactee) -> new AttackAction(ActionTypes.ATTACK_DIRECT, interactor, interactee)).playerAndInteractorSameOwner().interactorAndInteracteeNotSameOwner().interactorNonEmpty().addInteraction()
            ...
            .newAdvancedInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.SET).addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.ACTIVATE_SPELL_TRAP).interactorIncluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.CONTINUE_EFFECT).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee)  -> new EffectContinueAction(ActionTypes.CONTINUE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.SET).addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.CONTINUE_EFFECT).interactorIncluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee)  -> new EffectContinueAction(ActionTypes.CONTINUE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.HAND).interactorCardNotNull().interacteeEquals(ZoneTypes.HAND).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.GRAVEYARD).interactorCardNotNull().interacteeEquals(ZoneTypes.GRAVEYARD).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.BANISHED).interactorCardNotNull().interacteeEquals(ZoneTypes.BANISHED).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorIncluded(PlayFieldTypes.getAllDeckZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllDeckZones()).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.EXTRA).interactorCardNotNull().interacteeEquals(ZoneTypes.EXTRA).interaction((player, interactor, card, interactee)  -> new EffectActivateAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.NEGATE_EFFECT).interactorIncluded(PlayFieldTypes.getAllFieldZones()).interactorCardAny().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> new EffectNegateAction(ActionTypes.NEGATE_EFFECT, interactor, interactee)).playerAndInteractorSameOwner().interactorAndInteracteeNotSameOwner().interactorNonEmpty().interacteeNonEmpty().cardNotInPosition(CardPosition.SET).addInteraction()
            .newAdvancedInteraction().icon(ActionIcons.NEGATE_EFFECT).interactorIncluded(PlayFieldTypes.getAllFieldZones()).interactorCardAny().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee) -> new EffectNegateAction(ActionTypes.NEGATE_EFFECT, interactor, interactee)).playerAndInteractorSameOwner().interactorAndInteracteeNotSameOwner().interactorNonEmpty().interacteeNonEmpty().cardNotInPosition(CardPosition.FD).addInteraction()
            .newInteraction().icon(ActionIcons.BURN).interactorIncluded(PlayFieldTypes.getAllFieldZones()).interactorCardAny().interacteeEquals(ZoneTypes.HAND).interaction((player, interactor, card, interactee) -> new AttackAction(ActionTypes.BURN, interactor, interactee)).playerAndInteractorSameOwner().interactorAndInteracteeNotSameOwner().interactorNonEmpty().addInteraction()
            ;
