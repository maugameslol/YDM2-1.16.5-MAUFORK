...
public class PlayFieldTypes
{
    public static final PlayFieldType DEFAULT = new PlayFieldType(8000)
            ...
            .newInteraction().icon(ActionIcons.NEGATE_EFFECT).interactorIncluded(PlayFieldTypes.getAllFieldZones()).interactorCardAny().interacteeIncluded(PlayFieldTypes.getAllFieldZones()).interaction((player, interactor, card, interactee) -> new EffectNegateAction(ActionTypes.NEGATE_EFFECT, interactor, interactee)).playerAndInteractorSameOwner().interactorAndInteracteeNotSameOwner().interactorNonEmpty().interacteeNonEmpty().addInteraction()
            .newInteraction().icon(ActionIcons.BURN).interactorIncluded(PlayFieldTypes.getAllSpellZones()).interactorCardAny().interacteeEquals(ZoneTypes.HAND).interaction((player, interactor, card, interactee) -> new AttackAction(ActionTypes.ATTACK, interactor, interactee)).playerAndInteractorSameOwner().interactorAndInteracteeNotSameOwner().interactorNonEmpty().addInteraction()
            ;
