...
public class PlayFieldTypes
{
    public static final PlayFieldType DEFAULT = new PlayFieldType(8000)
            ...
            .newInteraction().icon(ActionIcons.FLIP_SPELL_TRAP).interactorExcluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.ATK, player)).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interacteeEmpty().addInteraction()
            .newInteraction().icon(ActionIcons.FLIP_SPELL_TRAP).interactorIncluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.ATK, player)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.ATK).addInteraction()
            ...
            .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee)  -> new ActivateEffectAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.SET).addInteraction()
            .newInteraction().icon(ActionIcons.ACTIVATE_SPELL_TRAP).interactorIncluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee)  -> new ActivateEffectAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction();
    ...
    /*
    .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.HAND).interactorCardNotNull().interacteeEquals(ZoneTypes.HAND).interaction((player, interactor, card, interactee)  -> new ActivateEffectAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().addInteraction()
    .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.GRAVEYARD).interactorCardNotNull().interacteeEquals(ZoneTypes.GRAVEYARD).interaction((player, interactor, card, interactee)  -> new ActivateEffectAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().addInteraction()
    .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorIncluded(PlayFieldTypes.getAllDeckZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllDeckZones()).interaction((player, interactor, card, interactee)  -> new ActivateEffectAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
    .newInteraction().icon(ActionIcons.ACTIVATE_EFFECT).interactorEquals(ZoneTypes.EXTRA).interactorCardNotNull().interacteeEquals(ZoneTypes.EXTRA).interaction((player, interactor, card, interactee)  -> new ActivateEffectAction(ActionTypes.ACTIVATE_EFFECT, interactee, card)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FD).addInteraction()
    */
